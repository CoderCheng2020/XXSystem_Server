...
{ public:
	...
	/// Variables globally declared in XX_System_Transportation.h (non-static)
	/// Constructor
	calcProxy();
	...
	/// Web service operation 'SendAndReceiveMessage' (returns error code or SOAP_OK)
	virtual	int SendAndReceiveMessage(char *sendMesssage, char **recevieMessage) { return this->SendAndReceiveMessage(NULL, NULL, sendMesssage, recevieMessage); }
	virtual	int SendAndReceiveMessage(const char *endpoint, const char *soap_action, char *sendMesssage, char **recevieMessage);
};
#endif
