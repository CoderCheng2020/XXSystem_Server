...
const char server[] = "http://192.168.0.148:10010";
...
char* pStr = "good good study, day day up!!!";
char* pReceStr = NULL;
	calc.SendAndReceiveMessage(pStr, &pReceStr);
cout<<"Receive string is "<<pReceStr<<endl;
